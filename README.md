...
**Statuses**: ✅ production-proven pattern · 🧪 built and smoke-tested, needs live-fire testing against the real service (each recipe README carries its checklist). Beyond these twenty-five, [docs/tool-universe.md](docs/tool-universe.md) maps 20+ more candidate tools (Azure DevOps, …) with their webhook capabilities.
