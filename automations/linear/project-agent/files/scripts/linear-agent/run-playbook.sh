...
- api_helper (GraphQL): scripts/linear-agent/api.sh '<query>' '<variables-json>'
- comment_helper (use this to post your ONE comment): scripts/linear-agent/comment.sh <issue_id> <body-file>
