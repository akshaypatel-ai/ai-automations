...
- api_helper (REST): scripts/front-agent/api.sh <METHOD> <path> [json-body]
- note_helper (use this to post your ONE internal comment — write PLAIN TEXT, it is posted as-is, and Front comments are structurally internal): scripts/front-agent/note.sh <conversation_id> <body-file>
