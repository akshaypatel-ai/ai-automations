...
- list_analyze_id: $LIST_ANALYZE_ID
- list_implement_id: $LIST_IMPLEMENT_ID
- agent_comment_marker (your comments MUST start with this, followed by " — "): $AGENT_MARKER
- api_helper (REST): scripts/trello-agent/api.sh <METHOD> <path> [curl args]
- comment_helper (use this to post your ONE comment): scripts/trello-agent/comment.sh <card_id> <body-file>
...
echo "running playbook '$PLAYBOOK' for card $ITEM_ID (brain: $AI_NAME, model: ${CLAUDE_MODEL:-default})"
