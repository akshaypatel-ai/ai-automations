...
- api_helper (REST v2, flat JSON): scripts/todoist-agent/api.sh <METHOD> <path> [json-body]
- comment_helper (use this to post your ONE comment): scripts/todoist-agent/comment.sh <task_id> <body-file>
