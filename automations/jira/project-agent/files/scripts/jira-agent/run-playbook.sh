...
# Usage: run-playbook.sh <analyze|respond|implement> <issue_key> [decision_json]
set -euo pipefail
...
- api_helper (REST): scripts/jira-agent/api.sh <METHOD> <path> [json-body]
- comment_helper (use this to post your ONE comment): scripts/jira-agent/comment.sh <issue_key> <body-file>
