...
RENDER_VARS="GITHUB_REPO HANDLERS TELEGRAM_CHAT_ID INCIDENT_WORKFLOWS AGENT_NAME PROJECT_NAME AUDIENCE STACK_NOTE BRAIN_NAME AI_MODEL WORKER_NAME"
...
echo "  + scripts/telegram-agent/ai/brain.sh  ($BRAIN_NAME)"
...
jq -n \
  ...
  '{recipe: "telegram/notify-agent", runtime: "github-actions", brain: $brain,
