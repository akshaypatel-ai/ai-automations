...
- api_helper (REST): scripts/zendesk-agent/api.sh <METHOD> <path> [json-body]
- note_helper (use this to post your ONE internal note — it is structurally private): scripts/zendesk-agent/note.sh <ticket_id> <body-file>
...
echo "running playbook '$PLAYBOOK' for ticket $ITEM_ID (brain: $AI_NAME, model: ${AI_MODEL:-default})"
